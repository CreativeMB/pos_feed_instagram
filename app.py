...
from main_app import tarea_programada_publicar_instagram  # Importa la función
import random
import json
import os
...
scheduler.add_job(
    ...
    trigger=CronTrigger(hour=12, minute=16, timezone=pytz.timezone("America/Bogota")),
